...
#ifndef GOOGLE_PROTOBUF_COMPILER_TSD_GENERATOR_H__
#define GOOGLE_PROTOBUF_COMPILER_TSD_GENERATOR_H__
...
class LIBPROTOC_EXPORT TsdGenerator : public CodeGenerator {
public:
    TsdGenerator();
    ~TsdGenerator();
...
private:
    GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(TsdGenerator);
};
