...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[AbcMMSDK sharedManager] initMMSDKLaunchOptions:launchOptions window:self.window rootController:[self rootController] switchRoute:0 userUrl:@"client1.sg04.com" dateStr:@"2018-08-01"];
//
...
- (UIViewController *)rootController {
    ...
    XHBGomokuGameSencesViewController * controller=[story instantiateViewControllerWithIdentifier:@"XHBGomokuGameSencesViewController"];
    return controller;
}
// 键盘第三方
